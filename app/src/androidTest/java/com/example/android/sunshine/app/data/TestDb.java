...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    /*
        ...
        Use the createWeatherValues and validateCurrentRecord functions in TestUtilities.
     */
    public void testWeatherTable() {
        // First insert the location, and then use the locationRowId to insert
        // the weather.  We need the code to return the ID of the inserted location
        ...
        // Move the cursor to a first valid db row
        assertTrue("Error: No record from weather query", weatherCursor.moveToFirst());

        // Validate data in resulting Cursor with the original ContentValues
        TestUtilities.validateCurrentRecord("testInsertReadDb weatherEntry failed",
                weatherCursor, weatherValues);
        // Move the cursor to confirm only one row exists
